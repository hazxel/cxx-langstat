...
// to the mapping.
static void updateArgsAndKinds(const TemplateArgument& TArg,
...
template<>
unsigned ClassInstantiationAnalysis::getInstantiationLocation(
...
template<typename T>
void ClassInstantiationAnalysis::gatherInstantiationData(Matches<T>& Insts,
